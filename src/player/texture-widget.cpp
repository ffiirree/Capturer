...
bool TextureWidget::IsSupported(const AVPixelFormat pix_fmt)
{
...
void TextureWidget::UpdateTextures(QRhiResourceUpdateBatch *rub)
{
...
void TextureWidget::initialize(QRhiCommandBuffer *cb)
{
    if (rhi_ != rhi()) {
        rhi_ = rhi();
    }
